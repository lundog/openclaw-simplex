...
- <code>src/simplex/simplex-node-client.ts</code>: official Node runtime adapter.
- <code>src/simplex/simplex-transport.ts</code>: active-client registry and runtime API execution.
