...
<Steps>
  ...
  <Step title="Configure the channel">
    Configure the default official Node runtime:
    ...
    <Info>
      The plugin uses the official <code>simplex-chat</code> Node package in the OpenClaw process. There is no separate SimpleX CLI process to start.
    </Info>
  </Step>
