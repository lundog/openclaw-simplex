...
<Steps>
  ...
  <Step title="Start the SimpleX runtime">
    ...
    <Info>
      This is a long-running foreground process. If you want it to start automatically, use <code>openclaw simplex runtime install-service</code> from <a href="/guide/runtime-setup">Runtime Setup</a>.
    </Info>
  </Step>
