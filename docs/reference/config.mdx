...
<Note>
  The default account is considered configured when <code>channels.openclaw-simplex</code> exists. Named accounts should set <code>dbFilePrefix</code> unless they intentionally inherit an explicit root prefix.
</Note>
